...
export const T2_Kinder =
  'Seine Kinder dürfen dabei nicht bei ihnen bleiben, sondern kommen in ein Kinderheim. Von anderen Familien in der Umgebung hört er, dass auch deren Kinder von ihren Eltern getrennt werden. Außerdem bekommen sie alle einheitliche Kleidung, die von der Organisation Angka ausgegeben wird. Die Roten Khmer sprechen oft von Angka, doch trotzdem können Bou Meng und seine Kollegen  nicht genau sagen, was diese Organisation mit ihnen zu tun hat und was sie macht. Sie sind sich nur einig, dass es besser ist, ihr gegenüber nicht negativ aufzufallen.'
...
export const T5_Straflager =
  'Während der langen Tage spricht er mit anderen Arbeitern, die ihm von ihren Lebensgeschichten berichten. Sie alle haben gemeinsam, dass sie sich nicht erklären können, warum sie auf die Plantage beordert wurden. Langsam realisiert er, dass die Plantage ein Straflager für Monarchisten, angebliche Agenten und in Ungnade gefallene Revolutionsanhänger ist.'
...
export const T7_Angst =
  'So vergehen Tage, Wochen, Monate. Unter den unmenschlichen Bedingungen schläft er jeden Abend mit der Angst ein, am nächsten Morgen selbst eine der verschwundenen Personen zu sein. Gleichzeitig fragt er sich immer wieder, was er falsch gemacht hatte, um so ins Visier der roten Khmer zu geraten...'
