...
export const T2_Kinder =
  'Seine Kinder dürfen dabei nicht bei ihnen bleiben, sondern kommen in ein Kinderheim. Von anderen Familien in der Umgebung hört er, dass auch deren Kinder von ihren Eltern getrennt werden. Außerdem bekommen sie alle einheitliche Kleidung, die von der Organisation Angka ausgegeben werden. Die Roten Khmer sprachen oft von Angka, doch viel erfahren Bou Meng und seine Kollegen trotzdem nicht.'
