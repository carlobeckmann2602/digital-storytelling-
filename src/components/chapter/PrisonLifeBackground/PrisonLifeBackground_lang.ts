...
export const T2_PrisonLife =
  'Die Gefangenen wurden regelmäßig  auf unmenschlichste Weise physisch und psychisch misshandelt. Die Gefängniswärter schreckten vor nichts zurück und nutzten ihre Macht schamlos aus. Die Roten Khmer erhofften sich durch die Folter von den Inhaftierten Informationen über vermeintliche Feinde des Regimes zu erlangen. Oft wurden unschuldige Menschen beschuldigt, Spione oder Mitglieder oppositioneller Gruppen zu sein. Dabei wurde keine gesellschaftliche Gruppe verschont: Selbst Mitglieder der Khmer-Kader wurden hier inhaftiert, gefoltert und anschließend hingerichtet.'
