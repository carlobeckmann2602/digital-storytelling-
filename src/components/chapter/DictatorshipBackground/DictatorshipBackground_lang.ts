...
export const H1_Kommunismus = 'Der Agrarkommunismus'
export const T1_Kommunismus =
  'Nach der Machtübernahme wollten die Roten Khmer ein radikal-kommunistisches System etablieren, das sich gegen die Urbanisierung und Technologisierung richtete und die Agrarwirtschaft in den Vordergrund stellte. Um den angestrebten Agrarkommunismus zu erreichen, führten sie im Zuge ihrer Herrschaft eine Vielzahl von Maßnahmen durch. Dies umfasste beispielsweise den Versuch, Geld und Währungen ganzheitlich abzuschaffen. Dazu wollte man mit Bücherverbrennungen und der Schließung des freien Industrie- und Dienstleistungssektors sowie Banken, Krankenhäusern und Schulen einer in ihren Augen gefährlichen gesellschaftlichen Entwicklung zu Lasten der ländlichen Bevölkerung entgegenwirken.'
...
export const I2_PolPot =
  'Pol Pot wird neuer Regierungschef, totalitärer Kurs des Regimes ist spätestens jetzt etabliert. Erster öffentlicher Auftritt Pol Pot als „Arbeiter einer Kautschukplantage“ 4. April 1976 Norodom Sihanouk wird wegen Kritik an Kurs von roten Khamer abgesetzt'
